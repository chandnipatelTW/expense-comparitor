...
public class ChargePrinterTest {
    ...
    public void shouldPrintTheFormattedCharges() {
        ...
        String formattedChargeOne = "Sale       2016-11-28      2016-11-29      UBER   *US NOV27 CQ6IT                       -27.67                                      some_file.csv\n";
        String formattedChargeTwo = "Sale       2016-11-28      2016-11-30      SALATA - LAS COLINAS                         -12.00                                      some_file.csv\n";
    ...
    public void shouldPrintTheFormattedFees() {
        Set<CreditCardActivity> activities = createCreditCardActivities();
        ChargePrinter.printChargesAsHumanReadable(activities);
        String formattedFeeOne = "Payment    2016-11-26      2016-11-27      Payment Thank You - Web                     3004.37                                      some_file.csv\n";
